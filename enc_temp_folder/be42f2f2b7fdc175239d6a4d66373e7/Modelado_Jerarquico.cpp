/*Tarea#6								Alvarado Lucas Elliot
Fecha de entrega: 04 de marzo 2025 					3182655117
*/
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 5 Elliot Alvarado Lucas", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelTemp = model = glm::translate(model, glm::vec3(1.5f, 0.5f, 0.0f));
		...
		//model antebrazo
		model = glm::translate(modelTemp, glm::vec3(1.5f, 0.0, 1.0f));
		model = glm::rotate(model, glm::radians(codo), glm::vec3(0.0f, 1.0, 0.0f));
		modelTemp = model = glm::translate(model, glm::vec3(1.0f, 0.0f, -1.0f));
		...
		//model palma
		model = glm::translate(modelTemp, glm::vec3(1.0f, 0.0, 0.0f));
