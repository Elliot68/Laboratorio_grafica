...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "P3_Elliot Alvarado Lucas", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   model = glm::translate(view, glm::vec3(0.0f, -3.0f, 0.0f));
	   model = glm::rotate(model, 45.0f, glm::vec3(0.0f, -2.0f, 0.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::mat4(1);
		model = glm::translate(view, glm::vec3(1.5f, -0.5f, 0.0f));
		model = glm::rotate(model, 45.0f, glm::vec3(0.0f, -2.0f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//triangulo4
		model = glm::mat4(1);
		model = glm::translate(view, glm::vec3(-3.0f, -3.0f, 0.0f));
		model = glm::rotate(model, 45.0f, glm::vec3(0.0f, -2.0f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//triangulo6
		model = glm::mat4(1);
		model = glm::translate(view, glm::vec3(0.0f, 2.0f, 0.0f));
		model = glm::rotate(model, 45.0f, glm::vec3(0.0f, -2.0f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
