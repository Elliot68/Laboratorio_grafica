/*Tarea#8             Alvarado Lucas Elliot
Fecha de entrega : 25 de marzo 2025             3182655117*/
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.9f, 0.1f, 0.6f);
