/*Tarea#9             								Alvarado Lucas Elliot
Fecha de entrega : 01 de abril 2025             	3182655117*/
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo9_EAL", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].specular"), 1.0f, 3.0f, 2.0f);
